#!/usr/bin/env python3
"""Verify the closed-sort binder record and its source bindings."""
...
WORKSPACE = "/Users/oobi/Documents/gpt3/veil-m2-type-binders"
...
COMMANDS = {
    ...
    "record": (["python3", "-I", "dev/m2-translate.py", "record", "--output",
                ".kanon-exec/m2-translation-type-binders-candidate"], 0),
...
def verify():
    ...
    for label, total, ending in (("translation-tests", 55, "OK\n"),
    ...
    return "Closed-sort binder validation: seven captures, source hashes and five sample rechecks verified."
...
if __name__ == "__main__":
    try:
        ...
        print(f"Closed-sort binder validation: {error}", file=sys.stderr)
        sys.exit(1)

#!/usr/bin/env python3
"""Verify the direct lambda application record and its source bindings."""
...
WORKSPACE = "/Users/oobi/Documents/gpt3/veil-m2-beta"
...
COMMANDS = {
    ...
    "record": (["python3", "-I", "dev/m2-translate.py", "record", "--output",
                ".kanon-exec/m2-translation-beta-candidate"], 0),
...
def verify():
    ...
    for label, total, ending in (("translation-tests", 38, "OK\n"),
    ...
    return "Direct lambda application validation: seven captures, source hashes and five sample rechecks verified."
...
if __name__ == "__main__":
    try:
        ...
        print(f"Direct lambda application validation: {error}", file=sys.stderr)
        sys.exit(1)

#!/usr/bin/env python3
"""Verify the closed-sort alias record and its source bindings."""
...
WORKSPACE = "/Users/oobi/Documents/gpt3/veil-m2-sort-aliases"
...
COMMANDS = {
    ...
    "record": (["python3", "-I", "dev/m2-translate.py", "record", "--output",
                ".kanon-exec/m2-translation-sort-aliases-candidate"], 0),
    ...
    "compiler-reuse": (["python3", "-I", "dev/validation/2026-09-18-m2-sort-aliases/verify.py",
                        "--compiler-reuse"], 0),
    "controls": (["python3", "-I", "dev/validation/2026-09-18-m2-sort-aliases/controls.py"], 0),
}
...
def verify():
    ...
    for label, total, ending in (("translation-tests", 71, "OK\n"),
    ...
    require(controls == {"baseline_passed": True, "syntactic_only_killed": True,
                         "erase_data_aliases_killed": True}, "mutation verdicts changed")
    ...
    return "Closed-sort alias validation: nine captures, source hashes and five sample rechecks verified."
...
if __name__ == "__main__":
    try:
        ...
        print(f"Closed-sort alias validation: {error}", file=sys.stderr)
        sys.exit(1)

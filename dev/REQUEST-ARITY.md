...
The JavaScript reactor validates the argument count of operations 1 to 27
...
[hard-link regressions](HARD-LINK.md) record row 26, and the
[file copy regressions](FILE-COPY.md) record row 27.

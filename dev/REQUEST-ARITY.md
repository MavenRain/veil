...
The JavaScript reactor validates the argument count of operations 1 to 48
...
[link timestamp regressions](FILE-LUTIMES.md) record row 47, and the
[file access regressions](FILE-ACCESS.md) record row 48.

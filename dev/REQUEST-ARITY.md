...
The JavaScript reactor validates the argument count of operations 1 to 32
...
[file mode regressions](FILE-MODE.md) record row 31, and the
[permission inspection regressions](FILE-PERMISSIONS.md) record row 32.

...
The JavaScript reactor validates the argument count of operations 1 to 25
...
[symlink target regressions](SYMLINK-TARGET.md) record row 24, and the
[symlink creation regressions](SYMLINK-CREATE.md) record row 25.

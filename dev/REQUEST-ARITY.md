...
The JavaScript reactor validates the argument count of operations 1 to 26
...
[symlink creation regressions](SYMLINK-CREATE.md) record row 25, and the
[hard-link regressions](HARD-LINK.md) record row 26.

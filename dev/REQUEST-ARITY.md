...
The JavaScript reactor validates the argument count of operations 1 to 41
...
[file allocation regressions](FILE-ALLOCATION.md) record row 40, and the
[filesystem capacity regressions](FILESYSTEM-CAPACITY.md) record row 41.
Operations 33 to 41 each require exactly one path argument.

...
The JavaScript reactor validates the argument count of operations 1 to 31
...
[file truncate regressions](FILE-TRUNCATE.md) record row 30, and the
[file mode regressions](FILE-MODE.md) record row 31.

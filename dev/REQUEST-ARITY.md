...
The JavaScript reactor validates the argument count of operations 1 to 24
...
[entry kind regressions](ENTRY-KIND.md) record row 23, and the
[symlink target regressions](SYMLINK-TARGET.md) record row 24.
